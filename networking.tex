...
\section{Remote Connections}
	...
	\begin{questions}{Servers}
		\rsrc{Virtualized Servers}\url{http://www.infoworld.com/article/2609482/data-center/data-center-review-puppet-vs-chef-vs-ansible-vs-salt.html}
	Jenkins/TeamCity/GoCI
	Nagios/Zenoss/NewRelic
	puppet/chef/ansible
