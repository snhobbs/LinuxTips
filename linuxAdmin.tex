...
\section{Processes}
	\begin{questions}{Process Info}
		\begin{questionAnswer}
			...
			\qItem{Nice}{Priority level [-20 (most) - 19 (least)] \ra 0 is default. Call with: nice "val" "process", reset the priority level with renice "new val" "PID"}
	...
	\begin{questions}{Process Signals}
		\begin{questionAnswer}
			...
			\qItem{kill}{Send a signal to a process with kill -s "val" (default is 15) \ra see man(7) signals for the signals}
		\end{questionAnswer}
	\end{questions}
